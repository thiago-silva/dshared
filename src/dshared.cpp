...
sdict_value_t*
MManager::create_sdict_value(sdict* d) {
  return segment.construct<sdict_value_t>
...
void
sdict_set_null_item(sdict* sd, const char* strkey) {
...
void
sdict_set_string_item(sdict* sd, const char* strkey, const char* value) {
  char_string*  key = manager->create_string(strkey);
...
void
sdict_set_number_item(sdict* sd, const char* strkey, long num) {
  char_string*  key = manager->create_string(strkey);
...
void
sdict_set_sdict_item(sdict* sd, const char* strkey, sdict* value) {
  char_string*  key = manager->create_string(strkey);
...
sdict_get_item(sdict* sd, const char* strkey) {
